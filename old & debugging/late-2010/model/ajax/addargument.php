...
if ($_GET['i1']) {
	...
	if (!mysql_query("INSERT INTO arguments (subargs,name,contextpt,source,source_author) VALUES ($subargs,$name,$contextpt,$source,$source_author)")) { ?>
		<db-error>
			<query><?php print "INSERT INTO arguments (subargs,name,contextpt,source,source_author) VALUES ($subargs,$name,$contextpt,$source,$source_author)"; ?></query>
			<error>
				<? print mysql_error(); ?>
			</error>
		</db-error>

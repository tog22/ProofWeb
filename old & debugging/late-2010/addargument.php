...
if ($_POST['i1']) {
	...
	$contextpt = "'".$_POST['contextpt']."'";
	$source = "'".addslashes($_POST['source'])."'";
	$source_author = "'".addslashes($_POST['source_author'])."'";
	$ck = mysql_query("INSERT INTO arguments (subargs,name,contextpt) VALUES ($subargs,$name,$contextpt)");
	// Success-reporting
	print ("INSERT INTO arguments (subargs,name,contextpt,source,source_author) VALUES ($subargs,$name,$contextpt,$source,$source_author)");

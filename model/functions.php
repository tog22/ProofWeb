...
function print_proposition ($p, $num = FALSE, $CONCLUSION = FALSE, $fromNums = NULL) {
	...
	if ($comments) {
		...
		if ($HAS_OFFICIAL) {
			?>
			<a class="comments-official" href="/props/view/ajax/view.php?type=proposition&anchor=comments&id=<?php print $p; ?>">Comments icon</a>
			<?
		} else {
			?>
			<a class="comments-unofficial" href="/props/view/ajax/view.php?type=proposition&anchor=comments&id=<?php print $p; ?>">Comments icon</a>
			<?
		}
	}
	if ($devMode) { ?>
...
function print_buttons ($p, $b, $c) { // could add TEST as default for $a
	...
	if ($b == ACCEPT) {
		print '<span class="tick-on button"><a href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=NULL" title="Accepted - click to undo"></a></span> ';
	} else if ($c == ACCEPT) {
		print '<span class="tick-c button"><a href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=1" title="Committed - click to accept"></a></span> ';
	} else {
		print '<span class="tick-off button"><a href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=1" title="Click to accept"></a></span> ';
	}
	if ($b == REJECT) {
		print '<span class="cross-on button"><a href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=NULL" title="Rejected - click to undo"></a></span> ';
	} else {
		print '<span class="cross-off button"><a href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=2" title="Click to reject"></a></span> ';
	}
	print '</span>';
}
...
function print_ajax_buttons ($p, $b, $c) { // could add TEST as default for $a
	...
	print '<span class="buttons">';
	if ($b == ACCEPT) {
		print '<span class="tick-on button"><a title="Take this back" class="'.$p.'" href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=NULL"></a></span> ';
	} else if ($c == ACCEPT) {
		print '<span class="tick-c button"><a title="Accept" class="'.$p.' committed" href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=1"></a></span> ';
	} else {
		print '<span class="tick-off button"><a title="Accept" class="'.$p.'" href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=1"></a></span> ';
	}
	if ($b == REJECT) {
		print '<span class="cross-on button"><a title="Take this back" class="'.$converse.'" href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=NULL"></a></span> ';
	} else {
		print '<span class="cross-off button"><a title="Reject" class="'.$converse.'" href="/props/model/php/set-attitude.php?p='.$p.'&amp;a=2"></a></span> ';
	}
	print '</span>';
}

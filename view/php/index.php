...
<div id="main">  
  ...
  <div>
	...
	<p class="navlabel"><a href="view.php?type=argument&id=all">Browse all arguments</a></p
	<div class="alternative-eg" style="font-size:0.85em;">
		<p>Or see arguments for the following example propositions:</p>
